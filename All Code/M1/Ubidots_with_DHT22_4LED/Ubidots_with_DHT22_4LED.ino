...
#include "DHTesp.h"
const char *My_SSID = "meow";
const char *My_Pass = "meowmeow";
const char *MQTT_Server = "things.ubidots.com";
const char *MQTT_User = "BBFF-Jp2I43cE9YMkzLwE2zipc9X8lNLyAk";
const char *MQTT_Pass = "BBFF-Jp2I43cE9YMkzLwE2zipc9X8lNLyAk";
const char *PTopic1 = "/v2.0/devices/pk009test";
const char *STopic1 = "/v2.0/devices/pk009test/humid";
const char *STopic2 = "/v2.0/devices/pk009test/tempp";
const char *STopic3 = "/v2.0/devices/pk009test/led1";
const char *STopic4 = "/v2.0/devices/pk009test/led2";
const char *STopic5 = "/v2.0/devices/pk009test/led3";
const char *STopic6 = "/v2.0/devices/pk009test/led4";
const char *STopic7 = "/v2.0/devices/pk009test/sw1";
const char *STopic8 = "/v2.0/devices/pk009test/sw2";
